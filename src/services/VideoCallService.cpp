...
{
    // Vision must pause before media preparation can acquire/feed the shared
    // camera. releaseResources() balances this notification even on failure.
    ...
    return m_mediaPort->prepare(m_snapshot, false, error);
}
